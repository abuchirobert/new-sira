...
router.route('/user').post(userController.createUser).get(authToken.verifyToken, adminAccess.checkAdmin, userController.getUsers).delete(userController.deleteUsers);
